...
export class ConnectionService {
  ...
  APIUrl = "http://arkoust-uapsa.xyz/api/"; readonly PhotoUrl = "http://arkoust-uapsa.xyz/media/";
  //APIUrl = "http://127.0.0.1:8000/"; readonly PhotoUrl = "http://127.0.0.1:8000/media/";
